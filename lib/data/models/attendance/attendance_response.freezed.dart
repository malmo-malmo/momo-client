...
class _$_AttendanceResponse implements _AttendanceResponse {
  ...
  @override
  String toString() {
    return 'AttendanceResponse(attendanceId: $attendanceId, nickname: $nickname, isAttend: $isAttend, imageUrl: $imageUrl, attendanceRate: $attendanceRate)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.isAttend, isAttend) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(isAttend),

...
class _$_ParticipantUser implements _ParticipantUser {
  ...
  @override
  String toString() {
    return 'ParticipantUser(userId: $userId, participantId: $participantId, nickname: $nickname, imageUrl: $imageUrl, attendanceRate: $attendanceRate)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, userId, participantId, nickname, imageUrl, attendanceRate);
